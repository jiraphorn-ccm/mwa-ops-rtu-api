...
const EXPECTED = [
  ...
  ["GET", "{{api_prefix}}/panels/{{panel_id}}/work-orders"],
  ["POST", "{{api_prefix}}/panels/{{panel_id}}/work-orders"],
  ["GET", "{{api_prefix}}/panels/{{panel_id}}/pm-reports"],
  ["GET", "{{api_prefix}}/panels/{{panel_id}}/cm-reports"],
  ["GET", "{{api_prefix}}/panel-devices/{{panel_device_id}}/work-orders"],
  ["GET", "{{api_prefix}}/panel-devices/{{panel_device_id}}/cm-reports"],
  ["GET", "{{api_prefix}}/panel-devices/{{panel_device_id}}/attachments"],
  ["POST", "{{api_prefix}}/panel-devices/{{panel_device_id}}/attachments"],
  ["GET", "{{api_prefix}}/calibrations/{{calibration_id}}/attachments"],
  ["POST", "{{api_prefix}}/calibrations/{{calibration_id}}/attachments"],
  ["GET", "{{api_prefix}}/work-orders"],
  ["POST", "{{api_prefix}}/work-orders"],
  ["GET", "{{api_prefix}}/work-orders/{{work_order_id}}"],
  ["PUT", "{{api_prefix}}/work-orders/{{work_order_id}}"],
  ["PATCH", "{{api_prefix}}/work-orders/{{work_order_id}}"],
  ["DELETE", "{{api_prefix}}/work-orders/{{work_order_id}}"],
  ["POST", "{{api_prefix}}/work-orders/{{work_order_id}}/restore"],
  ["POST", "{{api_prefix}}/work-orders/{{work_order_id}}/reassign"],
  ["POST", "{{api_prefix}}/work-orders/{{work_order_id}}/check-in"],
  ["POST", "{{api_prefix}}/work-orders/{{work_order_id}}/check-out"],
  ["GET", "{{api_prefix}}/work-orders/{{work_order_id}}/rounds"],
  ["GET", "{{api_prefix}}/work-orders/{{work_order_id}}/activity"],
  ["GET", "{{api_prefix}}/work-orders/{{work_order_id}}/approvals"],
  ["POST", "{{api_prefix}}/work-orders/{{work_order_id}}/approvals"],
  ["GET", "{{api_prefix}}/work-orders/{{work_order_id}}/pm-report"],
  ["PUT", "{{api_prefix}}/work-orders/{{work_order_id}}/pm-report"],
  ["POST", "{{api_prefix}}/work-orders/{{work_order_id}}/pm-report/submit"],
  ["GET", "{{api_prefix}}/work-orders/{{work_order_id}}/pm-reports"],
  ["GET", "{{api_prefix}}/work-orders/{{work_order_id}}/cm-report"],
  ["PUT", "{{api_prefix}}/work-orders/{{work_order_id}}/cm-report"],
  ["POST", "{{api_prefix}}/work-orders/{{work_order_id}}/cm-report/submit"],
  ["GET", "{{api_prefix}}/work-orders/{{work_order_id}}/cm-reports"],
  ["GET", "{{api_prefix}}/work-orders/{{work_order_id}}/attachments"],
  ["POST", "{{api_prefix}}/work-orders/{{work_order_id}}/attachments"],
  ["GET", "{{api_prefix}}/pm-reports/{{pm_report_id}}"],
  ["DELETE", "{{api_prefix}}/pm-reports/{{pm_report_id}}"],
  ["GET", "{{api_prefix}}/pm-reports/{{pm_report_id}}/onsite-fixes"],
  ["POST", "{{api_prefix}}/pm-reports/{{pm_report_id}}/onsite-fixes"],
  ["POST", "{{api_prefix}}/pm-reports/{{pm_report_id}}/escalate"],
  ["GET", "{{api_prefix}}/pm-reports/{{pm_report_id}}/attachments"],
  ["POST", "{{api_prefix}}/pm-reports/{{pm_report_id}}/attachments"],
  ["GET", "{{api_prefix}}/cm-reports/{{cm_report_id}}"],
  ["PUT", "{{api_prefix}}/cm-reports/{{cm_report_id}}"],
  ["PATCH", "{{api_prefix}}/cm-reports/{{cm_report_id}}"],
  ["DELETE", "{{api_prefix}}/cm-reports/{{cm_report_id}}"],
  ["GET", "{{api_prefix}}/cm-reports/{{cm_report_id}}/attachments"],
  ["POST", "{{api_prefix}}/cm-reports/{{cm_report_id}}/attachments"],
  ["GET", "{{api_prefix}}/pm-ground-tests/{{ground_test_id}}/attachments"],
  ["POST", "{{api_prefix}}/pm-ground-tests/{{ground_test_id}}/attachments"],
  ["GET", "{{api_prefix}}/pm-power-test-points/{{power_test_point_id}}/attachments"],
  ["POST", "{{api_prefix}}/pm-power-test-points/{{power_test_point_id}}/attachments"],
  ["GET", "{{api_prefix}}/engineers"],
  ["POST", "{{api_prefix}}/engineers"],
  ["GET", "{{api_prefix}}/engineers/{{engineer_id}}"],
  ["PUT", "{{api_prefix}}/engineers/{{engineer_id}}"],
  ["PATCH", "{{api_prefix}}/engineers/{{engineer_id}}"],
  ["DELETE", "{{api_prefix}}/engineers/{{engineer_id}}"],
  ["DELETE", "{{api_prefix}}/engineers/{{engineer_id}}/permanent"],
  ["POST", "{{api_prefix}}/engineers/{{engineer_id}}/restore"],
  ["GET", "{{api_prefix}}/checklist-items"],
  ["POST", "{{api_prefix}}/checklist-items"],
  ["GET", "{{api_prefix}}/checklist-items/{{checklist_item_id}}"],
  ["PUT", "{{api_prefix}}/checklist-items/{{checklist_item_id}}"],
  ["PATCH", "{{api_prefix}}/checklist-items/{{checklist_item_id}}"],
  ["DELETE", "{{api_prefix}}/checklist-items/{{checklist_item_id}}"],
  ["DELETE", "{{api_prefix}}/checklist-items/{{checklist_item_id}}/permanent"],
  ["POST", "{{api_prefix}}/checklist-items/{{checklist_item_id}}/restore"],
  ["GET", "{{api_prefix}}/problem-topics"],
  ["POST", "{{api_prefix}}/problem-topics"],
  ["GET", "{{api_prefix}}/problem-topics/{{problem_topic_id}}"],
  ["PUT", "{{api_prefix}}/problem-topics/{{problem_topic_id}}"],
  ["PATCH", "{{api_prefix}}/problem-topics/{{problem_topic_id}}"],
  ["DELETE", "{{api_prefix}}/problem-topics/{{problem_topic_id}}"],
  ["DELETE", "{{api_prefix}}/problem-topics/{{problem_topic_id}}/permanent"],
  ["POST", "{{api_prefix}}/problem-topics/{{problem_topic_id}}/restore"],
  ["GET", "{{api_prefix}}/attachments/{{attachment_id}}"],
  ["PUT", "{{api_prefix}}/attachments/{{attachment_id}}"],
  ["PATCH", "{{api_prefix}}/attachments/{{attachment_id}}"],
  ["DELETE", "{{api_prefix}}/attachments/{{attachment_id}}"],
